...
const GreenGuy = () => {
  useEffect(() => {
    ...
    const hat = document.querySelectorAll("g#hat");
    ...
    hatTimeline
      .set(hat, { y: 0 })
      .to(hat, { y: -50, rotation: -10, duration: 0.3, delay: 1 })
      .to(hat, { y: 0, rotation: 0, duration: 1, delay: 0.1 });

    armsTimeline
      .add(gsap.to(rightArm, { rotation: 7, duration: 2, yoyo: true, repeat: -1 }), 0)
      .add(gsap.to(leftArm, { rotation: -7, duration: 2, yoyo: true, repeat: -1 }), 0);
    ...
    if (!window.DeviceOrientationEvent) {
      window.addEventListener("deviceorientation", (e) => {
        ...
        gsap.to(eyeballs, { x: x * 15, y: y * 15, duration: 0.1 });
      });
    } else {
      ...
      >
        <g id="intro">
          <g id="right-arm">
            <g id="Vector">
              <path
                d="M311 393.1V544.3C311 553.5 303.6 560.9 294.4 560.9C285.2 560.9 277.8 553.5 277.8 544.3V393.1"
                fill="#5BB889"
              />
              <path
                d="M311 393.1V544.3C311 553.5 303.6 560.9 294.4 560.9C285.2 560.9 277.8 553.5 277.8 544.3V393.1"
          ...
          <path
            id="Vector_5"
            opacity="0.1"
            d="M220.9 522.9C232.2 522.6 243.3 521.3 254.1 519V461.6H220.9V522.9Z"
            fill="#1E193B"
            stroke="#1E193B"
            stroke-width="3"
            stroke-miterlimit="10"
          ...
          <g id="Group">
            <path
              id="Vector_14"
              d="M130.6 257.2C105.6 257.2 85.3 277.5 85.3 302.5C85.3 327.5 105.6 347.8 130.6 347.8"
              stroke="#1E193B"
              stroke-width="3"
              stroke-miterlimit="10"
              stroke-linecap="round"
          ...
          <g id="hat">
            ...
            <path
              id="Vector_21"
              d="M74.6521 110.635L22.7969 168.225L33.6461 177.994L85.5014 120.404L74.6521 110.635Z"
              fill="#E29F02"
              stroke="#1E193B"
              stroke-width="3"
              stroke-miterlimit="10"
          ...
          <g id="left-arm">
            <path
              d="M161.3 413.1V554.3C161.3 563.5 153.9 570.9 144.7 570.9C135.5 570.9 128.1 563.5 128.1 554.3V413.1"
              fill="#5BB889"
            />
            <path
              d="M161.3 413.1V554.3C161.3 563.5 153.9 570.9 144.7 570.9C135.5 570.9 128.1 563.5 128.1 554.3V413.1"
